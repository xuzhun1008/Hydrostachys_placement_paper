...
java -jar /mnt/c/Ubuntu/Astral/astral.5.7.7.jar -q astral_BS33.tre.rerooted -i ../03_bootstrap_contraction/02_338bootvalue.tre_BS33.tre -t 3 -o astral_BS33_scored_rooted_t3.tre 2> astral_BS33_scored_rooted_t3.log
