...
java -jar /Applications/Phylogeny/Astral/astral.5.7.3.jar -q astral.tre.rerooted -i ../01_unroot/338gene.tre -t 3 -o astral_scored_rooted_t3.tre 2> astral_scored_rooted_t3.log
...
# astral -q astral.tre.rerooted -i 338gene.tre -t 1 -o astral_scored_rooted_t1.tre 2> astral_scored_rooted_t1.log
