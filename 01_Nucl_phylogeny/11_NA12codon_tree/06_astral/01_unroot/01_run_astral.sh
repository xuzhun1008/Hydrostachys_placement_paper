...
# astral -q astral.tre -i 338gene.tre -t 1 -o astral_scored_t1.tre 2> astral_scored_t1.log

# Alternative posteriors
astral -q astral.tre -i 338gene.tre -t 4 -o astral_scored_t4.tre 2> astral_scored_t4.log
